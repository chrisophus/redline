...
func promptParts(in Input, opts Options, system string, budget envelope.Budgeted) []PromptPart {
	...
	return []PromptPart{
		...
		{"tools", toolsTokens(opts.DeferContext, opts.Look != nil)},
		...
		// only here.
		{"this pass", envelope.EstimateTokens(judgingTail + describingTail + callsBlock(StageReview, opts.DeferContext, opts.Look != nil))},
